							...
							<div class="card">
								<div class="card-header">
									...
									<div class="options-header">
										<?php
											if($buttons["create"]) { ?>
												<a href="periodo-letivo/inserir">Inserir</a>
											<? }
										?>
									</div>
								</div>
															...
															<?php
																if($buttons["edit"] || $buttons["delete"]) {
																	echo "<td class='buttons'>";
																		if($buttons["edit"]) { ?>
																			<div>
																				<a class="btn btn-success" href="periodo-letivo/editar/<?= $dado->id; ?>">Editar</a>
																			</div>
																		<? }
																		if($buttons["delete"]) { ?>
																			<div>
																				<a class="btn btn-danger" href="periodo-letivo/deletar/<?= $dado->id; ?>">Deletar</a>
																			</div>
																		<? }
																	echo "</td>";
																}
