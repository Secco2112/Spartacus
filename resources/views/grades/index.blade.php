							...
							<div class="card">
								...
								<div class="card-body collapse in">
									<div class="card-block">
										<form class="form form_notas" method="post" action="/notas/save_grades">
											@csrf
											<div class="row">
													...
													<div class="form-body">
														<div class="form-group courses">
															...
															<select name="course_id" id="course" class="form-control">
																<option selected disabled value="0">Selecione o curso</option>
																<?php
																	foreach ($teacher_courses as $key => $tc) { ?>
