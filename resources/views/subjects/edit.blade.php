												...
												<div class="col-md-6 offset-md-3">
													<div class="form-body">
														...
														<div class="form-group">
															...
															<textarea id="description" class="form-control" value="" name="description"><?= $dados->description; ?></textarea>
														</div>
														<div class="form-group">
															...
															<select class="form-control" name="course_id" id="course_id">
																...
																<?php
																	foreach ($courses as $key => $course) { ?>
																		<option value="<?= $course->id ?>" <?= $dados->course_id == $course->id? "selected": ""; ?>><?= $course->name; ?></option>
																	<? }
																?>
															</select>
														</div>
															...
															<select class="form-control" name="teacher_id" id="teacher_id">
																...
																<?php
																	foreach ($teachers as $key => $teacher) { ?>
																		<option value="<?= $teacher->id ?>" <?= $dados->teacher_id == $teacher->id? "selected": ""; ?>><?= $teacher->name; ?></option>
																	<? }
																?>
															</select>
														</div>
