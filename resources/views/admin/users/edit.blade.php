							...
							<div class="card">
								...
								<div class="card-body collapse in">
									<div class="card-block">
										...
										<form class="form user-form" method="post" action="">
											@csrf
											<div class="row">
												<div class="col-md-12">
													<div class="form-body">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	?>
																	<input type="text" id="date_of_birth" class="form-control" value="<?= $datetime->format("d/m/Y"); ?>" name="date_of_birth">
																</div>
															</div>
														</div>
														<div class="row">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="text" id="mother_name" class="form-control" value="<?= $student->mother_name; ?>" name="mother_name">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label for="mother_document">Documento da mãe</label>
																	<input type="text" id="mother_document" class="form-control" value="<?= $student->mother_document; ?>" name="mother_document">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="text" id="father_name" class="form-control" value="<?= $student->father_name; ?>" name="father_name">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label for="father_document">Documento do pai</label>
																	<input type="text" id="father_document" class="form-control" value="<?= $student->father_document; ?>" name="father_document">
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="text" id="zipcode" class="form-control" value="<?= $student->zipcode; ?>" name="zipcode">
																</div>
															</div>
															<div class="col-md-6">
																<div class="row">
																	<div class="col-md-8">
																		<div class="form-group">
																			...
																			<input type="text" id="address" class="form-control" value="<?= $student->address; ?>" name="address">
																		</div>
																	</div>
																	<div class="col-md-3">
																		<div class="form-group">
																			<label for="number">Número</label>
																			<input type="text" id="number" class="form-control" value="<?= $student->number; ?>" name="number">
																		</div>
																	</div>
																	<div class="col-md-1">
																		<div class="form-group custom-checkbox">
																			...
																			<div class="container">
																				<input type="checkbox" id="no_number" class="form-control" <?= $student->no_number == 1? "checked": ""; ?> name="no_number">
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="text" id="neighborhood" class="form-control" value="<?= $student->neighborhood; ?>" name="neighborhood">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label for="complement">Complemento</label>
																	<input type="text" id="complement" class="form-control" value="<?= $student->complement; ?>" name="complement">
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<input type="text" id="cellphone" class="form-control" value="<?= $student->cellphone; ?>" name="cellphone">
																</div>
															</div>
															<div class="col-md-6">
																<div class="form-group">
																	<label for="phone">Telefone</label>
																	<input type="text" id="phone" class="form-control" value="<?= $student->phone; ?>" name="phone">
																</div>
															</div>
														</div>
													</div>
